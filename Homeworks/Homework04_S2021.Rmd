...
2. Open a new `.Rnw` document and copy in the letter template. To get it to run, you will need an image for the letterhead, and an image for your signature. See if you can find a UVM logo on line, and also use your phone to take a picture of your own signature.
