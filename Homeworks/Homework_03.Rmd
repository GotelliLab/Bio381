...
8. Now, using the skills you've just been practicing, open up this .csv file and paste it to your text editor: [Bombus File] this is a messy and truncated version of a dataset collected by Dr. Alex Burnham that recorded pathogen load in groups of Bombus species. 
-------------------------
## More resources
