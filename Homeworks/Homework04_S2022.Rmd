...
5. Use R to create a vector of all of the integers from 1 to 100 that are not divisible by 2, 3, or 7. You will need one of the arithmetic operators on [this cheat sheet](OperatorsCheatSheet.pdf).
