...
For this exercise, use your newly-developed `ggplot` chops to create some nice graphs from a dataset from the TidyTuesday Dataset project [Git Hub Link](https://github.com/rfordatascience/tidytuesday). Look through the database and pick a dataset that you'd like to work with. You'll be responsible for creating at least 4 visualizations and plots. Experiment with different themes, theme base sizes, aesthetics, mappings, and faceting. When you are finished, try exporting them to high quality pdfs, jpgs, eps files, or other formats that you would use for submission to a journal.
...
You can make any combination of four plots from the list below: 
