...
2. Once the code is in and runs, try running this analysis on your own data (or data from your lab, or data from a published paper). Find a vector of data (of any size), set it up in a `.csv` file, and read the data into a data frame with this code chunk:
