...
2. Once the code is in and runs, try running this analysis on your own data (or data from your lab, or data from a published paper; if you're stumped, check out publicly available data sets on [Dryad](https://datadryad.org/search) and [ESA](https://data.esa.org)). Find a vector of data (of any size), set it up in a `.csv` file, and read the data into a data frame with this code chunk:
