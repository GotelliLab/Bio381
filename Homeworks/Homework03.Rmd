...
3. Study the code example and additional links for `Flowchart` and `Mermaid -> Flowchart` packages. Follow the links to   [Draw Diagrams With Markdown](http://support.typora.io/Draw-Diagrams-With-Markdown/)  and [Mermaid](https://knsv.github.io/mermaid/#mermaid) for additional details on building flowcharts.
