...
- `Sync (=fetch)` The GitHub desktop software combines pushing and pulling into a single operation. At the end of a sync, the copy of your local repository is identical to what is on GitHub. Syncing also updates your webpages that are associated with the project with any changes that you have made to the `.html` pages.  
