...
# run a double loop and apply to each element of matrix

output <- m # set up output with same dimensions as input matrix
print(output)
output[,] <- NA # assign each element in matrix an NA
