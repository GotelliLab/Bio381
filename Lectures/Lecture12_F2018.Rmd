...
qplot(runif(n=1000,min=0,max=5))
#-------------------------------------------------
```
#### Normal distribution
...
qplot(rgamma(n=100,shape=2,scale=100))
qplot(rgamma(n=100,shape=2,scale=10))
qplot(rgamma(n=100,shape=2,scale=1))
qplot(rgamma(n=100,shape=2,scale=0.1))
