...
library(ggplot2)
Histo <- function(xData) {
  z <- qplot(x=xData,color=I("black"),fill=I("tan"),xlab="X",boundary=0)
print(z)
print(summary(xData))
}
...
iHisto <- function(xData) {
z <- qplot(x=factor(xData),color=I("black"),fill=I("tan"),xlab="X")
print(z)
print (summary(xData))
}
