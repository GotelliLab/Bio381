...
## LaTeX
For LaTeX, Mac users can download and install MacTeX here: https://tug.org/mactex/mactex-download.html. After you restart RStudio, you should be able to knit to PDF.

Windows users can download and install MiKTeX here: https://miktex.org/download and should click "always install missing packages on the fly" during installation and then restart RStudio, as well.
