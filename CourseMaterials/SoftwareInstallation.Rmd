...
Installing new software can sometimes be tricky. If you run into any issues please contact me or Lauren or Emily, and we should be able to help you out.


## Detailed Installation Instructions

Lauren has graciously provided a much more detailed set of instructions for installing the software that you will need. If you are having any troubles, consult this page
...
## R
R is the basic computational language we will use in this class. We will use R not only for coding, but also for taking notes, displaying code, and creating slides and graphs. The latest version of R (30 December 2022) is 4.1.2 ("Bird Hippie").   

[download R](http://lib.stat.cmu.edu/R/CRAN/ )

## RStudio
RStudio is an IDE (Integrated Development Environment), which is a special editor that makes it much easier to use R and adds a number of useful features. **Make sure you have installed/updated R first before you install/update RStudio**. Choose either the Windows or Mac OS installer. The latest version of RStudio (30 December 2022) is RStudio 2021.09.1+372.
...
If you already know how to install packages in R (either by issuing commands from the original R terminal or through the GUI in RStudio), go ahead and install `tinytex`, `tidyverse`, and `patchwork`. If you don't know how to install R packages, please contact me or Emily or Lauren and we will step you through it.
...
This Cygwin installation is optional because a minimal shell is now included as part of R studio, and that is what we will use for all of your github operations. Time permitting, we will cover other shell operations near the end of the course, and Windows users may need Cygwin at that time.
